...
export default function Header() {
    return (
        <header className="fixed top-0 z-50 w-full  bg-[linear-gradient(to_bottom,var(--color-bg)_72px,transparent)] flex justify-center h-40">
            <nav className="flex justify-center gap-12 w-full max-w-xl font-display text-2xl text-brand py-4">
