...
export default function HeroSection() {
    return (
        <section id="home" className="relative h-screen overflow-hidden bg-bg flex flex-col lg:grid lg:grid-cols-2 lg:gap-0  justify-end gap-16 px-4 lg:px-0 pt-80 lg:pt-0 pb-10">
